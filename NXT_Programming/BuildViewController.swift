...
//        startButton.addTarget(self, action: #selector(dragStart(control:event:)), for: UIControlEvents.touchDragExit)
    ...
    func createSound()->UIView{
        ...
        durationButton = createButton(title: "time", _x: 80, _y: 80, _width: 35, _height: 40)
        
        var deleteButton = UIButton();
        deleteButton = createButton(title: "X", _x: 80, _y: 0, _width: 20, _height: 30)
        
        let volumeLabel = UILabel()
        volumeLabel.frame = CGRect(x: 0, y: 40, width: 120, height: 40)
        volumeLabel.text = "50"
        
        let playTypeLabel = UILabel()
        playTypeLabel.frame = CGRect(x: 30, y: 40, width: 120, height: 40)
        playTypeLabel.text = "file"
        
        let durationLabel = UILabel()
        durationLabel.frame = CGRect(x: 60, y: 40, width: 120, height: 40)
        durationLabel.text = "50"
        ...
        tempView.addSubview(deleteButton)
        tempView.addSubview(durationButton)
    ...
    func createWait()->UIView{
        ...
        timeLabel.frame = CGRect(x:0, y: 40, width: 35, height: 40)
        timeLabel.text = "5"
    ...
    func createStartLoop()->UIView{
        ...
        typeButton = createButton(title: "type", _x: 40, _y: 80, _width: 35, _height: 40)
        ...
        //typeButton.addTarget(self, action: #selector(typeAlertLoop(sender:event:)), for: UIControlEvents.touchUpInside)
        
        tempView.addSubview(name)
        tempView.addSubview(loopsButton)
        tempView.addSubview(typeButton)
        tempView.addSubview(deleteButton)
        self.view.addSubview(tempView)
...
//            newSL.setTime(newTime: 5)
    ...
    func volumeAlertSound(sender: Any, event: UIEvent)->String{
        ...
        var ans = String()
        let alert = UIAlertController(title: "Sound Volume", message: "Enter a volume from 0 to 1000", preferredStyle: .alert)
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { [weak alert] (_) in
            ...
            let tempObj = self.objectSequence[index] as! SoundObject
    ...
    func timeAlertWait(sender: Any, event: UIEvent)->String{
        var ans = String()
        let alert = UIAlertController(title: "Wait time", message: "Enter how long to wait in seconds", preferredStyle: .alert)
...
//    }
    ...
    func loopsAlertLoop(sender: Any, event: UIEvent)->String{
        var ans = String()
        let alert = UIAlertController(title: "Loops number", message: "Enter number of loops to perform", preferredStyle: .alert)
